    ...
    return (
      <div>
        <div className="flex-1 space-y-8">
          ...
          <h1 className="max-w-2xl mb-8 text-4xl font-bold leading-none tracking-tight text-white uppercase font-Poppins drop-shadow-md md:text-6xl">
            <span className="absolute items-center flex-1 flex-shrink-0 px-4 py-2 mb-4 bg-yellow-400 rounded-md">
              <span className="mr-4 overflow-hidden">{displayText}</span>
              <FlashingCursor interval={700} />
            </span>
            <br />
            <span className="inline-block mt-8">Developer</span>
          </h1>
        </div>
        <div
